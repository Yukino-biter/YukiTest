-- Mock data for YukiTest (H2)

-- User: testuser / 123456
INSERT INTO yuki_user (id, username, password, nickname, status) VALUES
(1, 'testuser', '$2b$10$t9T2dCwr/U3Q8EYmthAuyu31H9HX2c8/lA64TK34poSjXZSxv3fgC', 'ゆき', 1);

-- Paper: N2 2024年7月
INSERT INTO yuki_paper (id, level, paper_name, exam_minutes, is_published) VALUES
(1, 'N2', '2024年7月 N2 真題', 165, 1);

-- Question Main 1: vocabulary
INSERT INTO yuki_question_main (id, paper_id, level, section, title, material, sort_order) VALUES
(1, 1, 'N2', 'vocabulary', '問題1　漢字読み', NULL, 1);

-- Question Main 2: grammar
INSERT INTO yuki_question_main (id, paper_id, level, section, title, material, sort_order) VALUES
(2, 1, 'N2', 'grammar', '問題3　文法', NULL, 2);

-- Question Main 3: reading (with long material)
INSERT INTO yuki_question_main (id, paper_id, level, section, title, material, sort_order) VALUES
...
-- Vocabulary items
INSERT INTO yuki_question_item (id, main_id, content, options, correct_answer, sort_order) VALUES
